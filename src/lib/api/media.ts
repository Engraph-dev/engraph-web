...
// 	args: ManageMediaArgs,
// ): Promise<ManageMediaRet> {
...
// 		mediaFiles.map(
// 			async (mediaFile, mediaIdx): Promise<ManageMediaSingleRet> => {
// 				const objectKey = objectKeyGenerator(mediaFile, mediaIdx)

// 				const urlReq = await makeAPIRequest<
// 					MediaEndpointResponse,
// 					NoParams,
// 					MediaEndpointRequestBody
// 				>({
...
// 				try {
// 					const s3Response = await fetch(objectUrl, {
...
// 					if (s3Response.ok) {
// 						const callbackRes = await makeAPIRequest<
// 							{},
// 							MediaCallbackParams
// 						>({
...
// 							}
// 						} else if (
// 							callbackRes.responseData.responseStatus !==
// 							"SUCCESS"
// 						) {
// 							return {
// 								objectKey: objectKey,
